...
public:
    ...
    System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor, const bool bUseViewer = true, const bool enableLoopClosing = true, const int initFr = 0, const string &strSequence = std::string());
